      ...
      <div className="flex h-[4.25rem] items-center justify-between gap-4 pl-2 pr-4 sm:pr-6 lg:pr-8">
        <div className="flex min-w-0 flex-1 items-center gap-4">
          <div
            ...
            aria-hidden
          />
          <Link to="/admin/dashboard" className="flex min-w-0 items-center transition-opacity hover:opacity-90">
            <img
              src="/img/logo-full.png"
              alt="IT&B"
              className="h-10 w-auto max-w-[180px] shrink-0 object-contain sm:h-11 sm:max-w-[200px]"
            />
          </Link>
        </div>
